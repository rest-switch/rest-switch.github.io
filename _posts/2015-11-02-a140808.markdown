...
toc: >
          <ul class="nav nav-stacked">
            ...
            <li><a href="#a140808-setup">A140808&nbsp;Setup</a></li>
...
The system is now ready to be used. The control panel web page can be accessed via the <code>/secure</code> route: <code>https://mydomain.com/secure/</code>  Note that if a custom port other than 443 was used, it is necessary to supply it here: <code>https://mydomain.com:8443/secure/</code>  Also note that if a custom port is used, the trailing slash MUST be specified or the browser will attempt to 301 follow the URL using the default port.
...
At this point we are ready to configure an A140808 device for use with the system and run an end-to-end test!
