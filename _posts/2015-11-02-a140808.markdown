...
###Table of Contents
  ...
  * [Building the Firmware](#building_firmware)
  * [Flashing the Firmware](#flashing_firmware)
  * [Booting and SSH](#booting_ssh)
  * [Building the Webserver](#building_webserver)
...
<p style="margin: 0"><span>&nbsp;</span></p>
<p style="padding-left: 1em; margin: 0">AVRISP mkII</p>
{% highlight sh %}
make avr-program
{% endhighlight %}

<p style="padding-left: 1em; margin: 0">MiniPro TL866A</p>
{% highlight sh %}
make mp-program
{% endhighlight %}
...
The next step is to program the HLK-RM04. This step requires MiniPro TL866A and an 8 pin SOIC test clip. Start by identifying the flash memory on the HLK-RM04 device. The make and model of the flash memory is required when writing to the part.
