...
The device used in this project <strike>is available from <a href="http://www.aliexpress.com/item/Free-shipping-KR-0808WIFI-S5A-wifi-version-8-into-8-out-of-relay-module/1945279388.html" target="_blank">AliExpress</a> for approximately $57 at the time of this writing</strike>. <span style="color:red">Edit 2/1/2016: This article appears to have sold out the original inventory on this item. Another source on <a href="http://www.aliexpress.com/item/WIFI-network-relay-control-board-network-relay-controller-mobile-phone-relay-control-switch/1545652879.html" target="_blank">AliExpress</a> sells this item for $106 at the time of this update.</span> It comes with no useful documentation and its factory configuration is of limited value. There is no model number, so I decided to call it the A140808 which encodes the fact that it was the first project device (A) that I bought in 2014 and it has 08 inputs and 08 outputs.
