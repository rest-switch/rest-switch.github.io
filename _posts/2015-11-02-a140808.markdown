...
The web server used in this project is <a href="http://nginx.org" target="_blank">Nginx</a>. The modular nature of Nginx lends itself well to not only serving html content, but it can also provide a rock-solid publish-subscribe facility through the use of <a href="https://br.linkedin.com/in/wandenberg-peixoto-52582a8" target="_blank">Wandenberg Peixoto’s</a> highly scalable <a href="https://github.com/wandenberg/nginx-push-stream-module" target="_blank">pushstream module</a>. Other benefits of Nginx include extremely easy SSL setup and configuration as well as a wide range of other integration modules. While the overall solution was demonstrated to work equally well with both <a href="https://nodejs.org" target="_blank">node.js</a> and <a href="http://redis.io/topics/pubsub" target="_blank">Redis</a>, the simplicity and overall completeness of Nginx edged out the competition for this application. It should be noted that all three are excellent and suitable technology choices, however. The entire Nginx deployment package is bundled using a <a href="https://www.docker.com" target="_blank">docker container</a> which greatly simplifies numerous potential configuration and installation pitfalls making the entire process nearly foolproof.
